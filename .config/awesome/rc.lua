...
vicious.register(mybattery, vicious.widgets.bat,
    function(widgets, args)
        if args[1] == "-" then
            if args[2] < 10 then
               return " <span color='tomato'>↯:" .. args[2] .. "%</span> "
            else
               return " <span color='orange'>↯:" .. args[2] .. "%</span> "
            end
        else
            return " <span color='lightgreen'>↯:" .. args[2] .. "%</span> "
        end
    end, 10, "BAT1")
...
vicious.register(myvolume, vicious.widgets.volume,
    function(widget, args)
        if args[2] == "♫" then
            ...
            return " <span color='orange'>" .. args[2] .. ":" .. args[1] .. "%</span> "
        end
    end, 1, "Master")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "p",     function () awful.spawn("mpc toggle") end,
              {description = "play/pause mopidy", group = "launcher"})
)
